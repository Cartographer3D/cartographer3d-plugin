...
def test_touch_home_macro_moves(
    ...
    macro = TouchHomeMacro(probe, toolhead, home_position=(10, 10), travel_speed=50,nozzle_diameter=0.4,random_touch_home=0)
...
def test_touch_home_macro(
    ...
    macro = TouchHomeMacro(probe, toolhead, home_position=(10, 10), travel_speed=50,nozzle_diameter=0.4,random_touch_home=1)
